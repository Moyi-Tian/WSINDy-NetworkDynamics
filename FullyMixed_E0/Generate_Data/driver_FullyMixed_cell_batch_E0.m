...
U0 = 1-E0;
D0 = zeros(1,length(E0));
P0 = zeros(1,length(E0));
R0 = zeros(1,length(E0));
...
if save_data == 1
    ...
    fname = sprintf('Fully-Mixed Network Dynamics batch %u E0=%.5g-%.5g, beta=%.3g, theta=%.3g, eta=%.3g, gamma_i=%.3g, gamma_p=%.3g, tmax=%u, t_grid_num=%u.mat',length(E0),E0(1),E0(end),pars(1),pars(2),pars(3),pars(4),pars(5),time_range(end),t_num);
